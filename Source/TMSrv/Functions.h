...
static int(*BASE_CanEquip)(st_Item *, st_Status *, int, int, st_Item *) = (int f_ptr(st_Item *, st_Status *, int, int, st_Item *)) 0x0040100F; // Lib: Basedef.obj Class : (null)
static int(*BASE_CanCarry)(st_Item *, st_Item *, int, int, int *) = (int f_ptr(st_Item *, st_Item *, int, int, int *)) 0x00401334; // Lib: Basedef.obj Class : (null)
static int(*BASE_CanCargo)(st_Item *, st_Item *, int, int) = (int f_ptr(st_Item *, st_Item *, int, int)) 0x004010A5; // Lib: Basedef.obj Class : (null)
...
static void(*BASE_ClearItem)(st_Item *Item) = (void f_ptr(st_Item *Item)) 0x004014C4; // Lib: Basedef.obj Class : (null)
...
static int(*BASE_GetMobAbility)(st_Mob*, unsigned char) = (int f_ptr(st_Mob*, unsigned char)) 0x00401046; // Lib: Basedef.obj Class : (null)
...
static MapAttribute(*GetAttribute)(int, int) = (MapAttribute(__cdecl*)(int, int)) 0x004014AB; // Lib: GetFunc.obj Class : (null)
...
static int(*BASE_GetArena)(int, int) = (int f_ptr(int, int)) 0x00401375; // Lib: Basedef.obj Class : (null)
