...
void CorrectSomeSizes()
{
	...
	*(INT8*)(0x00422BFA + 1) = 44;
	...
	// Remove bug não tomar dano mágico de mobs quando tem 100 de imu
	...
	*(DWORD*)0x004523FD = 0x7FFF;
	...
	// Altera o jump para os players não levarem mais disconect.
...
void SetPacketSize()
{
	...
	*(BYTE*)0x0040FC24 = 60;
	...
	// Altera o tamanho de checagem do pacote DeleteChar (0x809). Padrão : 0x20
